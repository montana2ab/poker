...
class MCCFRConfig:
    ...
    # - "dense": Use Python dicts with float64 (default, current behavior)
    # - "compact": Use numpy arrays with int32/float32 for ~50% memory reduction
    regret_storage_mode: str = "dense"  # Storage backend: "dense" or "compact"
