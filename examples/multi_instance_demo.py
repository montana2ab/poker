...
def main():
    ...
    print("-" * 70)
    print("Example 2: With Checkpointing (Iteration Mode)")
    print("-" * 70)
    print()
    print("python -m holdem.cli.train_blueprint \\")
    print("  --buckets assets/abstraction/precomputed_buckets.pkl \\")
    ...
    print("-" * 70)
    print("Example 3: Time-Budget Mode (8 Hours)")
    print("-" * 70)
    print()
    print("python -m holdem.cli.train_blueprint \\")
    print("  --buckets assets/abstraction/precomputed_buckets.pkl \\")
    print("  --logdir runs/8hour_multi \\")
    print("  --time-budget 28800 \\")
    print("  --num-instances 4 \\")
    print("  --snapshot-interval 1800")
    print()
    print("This will:")
    print("  - Launch 4 instances, each running for 8 hours")
    print("  - All instances explore independently")
    print("  - Snapshots saved every 30 minutes")
    print("  - Produces 4 independent strategies")
    print()
    
    print("-" * 70)
    print("Example 4: Large Scale Training")
    print("-" * 70)
    print()
    print("python -m holdem.cli.train_blueprint \\")
    print("  --buckets assets/abstraction/precomputed_buckets.pkl \\")
    ...
    print("-" * 70)
    print()
    print("✓ Iteration mode: Iterations are distributed across instances (no overlap)")
    print("✓ Time-budget mode: All instances run for the same duration independently")
    print("✓ Compatible: --iters, --time-budget, --checkpoint-interval, --snapshot-interval")
    print("✗ Not compatible: --num-workers (forced to 1), --resume-from")
    print()
